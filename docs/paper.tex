...
\textbf{Hyperparameter sensitivity.} The gamma spread $a$ exhibits a clear U-shaped optimum: $a{=}0.5$ gives 7.60 PPL (+32\%), $a{=}1.0$ gives 5.77 (best), $a{=}1.5$ gives 6.13 (+6\%), $a{=}2.0$ gives 6.22 (+8\%). The optimal $a{=}1.0$ is robust across datasets and model sizes, requiring no tuning.
