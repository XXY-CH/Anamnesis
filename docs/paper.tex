...
\begin{table}[h]
\centering
\caption{Cross-dataset char-level PPL at 5K steps (lr$=10^{-3}$, d=128, 8 layers).}
\begin{tabular}{lccc}
\toprule
Dataset & Anamnesis & Transformer & $\Delta$ \\
\midrule
Shakespeare (3 seeds) & 3.12$\pm$0.11 & 3.94$\pm$0.07 & \textbf{-20.8\%} \\
TinyStories (3 seeds) & 2.82$\pm$0.03 & 5.22 & \textbf{-46.0\%} \\
WikiText-2 (2 seeds) & 4.95$\pm$0.18 & 5.88$\pm$0.00 & \textbf{-15.8\%} \\
\bottomrule
\end{tabular}
\end{table}
