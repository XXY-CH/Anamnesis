...
\begin{table}[h]
\centering
\caption{TinyStories char-level PPL at 5K steps (vocab=94, 10M train chars). Single seed.}
\begin{tabular}{lcccc}
\toprule
Model & d & Params & PPL & $\Delta$ vs TF \\
\midrule
\textbf{Anamnesis} & \textbf{128} & 7.9M & \textbf{3.57} & \textbf{-31.5\%} \\
