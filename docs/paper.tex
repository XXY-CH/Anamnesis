...
\textbf{Hyperparameter sensitivity.} The gamma spread $a$ exhibits a clear U-shaped optimum: $a{=}0.5$ gives 7.60 PPL (+32\%), $a{=}1.0$ gives 5.77 (best), $a{=}1.5$ gives 6.13 (+6\%), $a{=}2.0$ gives 6.22 (+8\%). Similarly, Engram slots $K$: $K{=}2048$ gives 6.96 (+21\%), $K{=}4096$ gives 5.77 (best), $K{=}8192$ gives 6.09 (+6\%). Both defaults ($a{=}1.0$, $K{=}4096$) are robust optima requiring no tuning.
